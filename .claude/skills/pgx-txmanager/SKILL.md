...
результатов батча (регрессия v5.9.0). Брать стоит последнюю патч-версию ветки v5
(на 2026-09-15 это v5.11.0); что именно последнее — смотреть не здесь, а через
`go list -m -u github.com/jackc/pgx/v5`, эта строка стареет быстрее скилла.
